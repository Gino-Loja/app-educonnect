...
const LoginPage = () => {
  ...
  const handleSubmit = async (e:any) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert(`¡Bienvenido/a! Iniciando sesión como ${userType === 'student' ? 'Estudiante' : 'Profesor'}`);
    }, 2000);
  };
              ...
              <p className="text-gray-600">
                ...
                <button 
                  ...
                  className={`font-medium transition-colors ${
                    userType === 'student' ? 'text-blue-600 hover:text-blue-700' : 'text-purple-600 hover:text-purple-700'
                  }`}
                >
                  Regístrate gratis
                </button>
